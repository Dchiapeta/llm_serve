// Vendorado de keenthemes/reui (MIT), registry/bases/radix/ui/pagination.tsx —
// o registry reui.io/r/* exige REUI_LICENSE_KEY e devolve 401, então
// `shadcn add @reui/...` não funciona aqui. Só os imports foram reescritos
// (@/registry/bases/radix/* -> @/lib, @/components/*); manter fiel ao upstream
// pra que uma atualização futura continue sendo um diff pequeno.
// Os estilos cn-pagination-* vêm de app/style-nova.css.
