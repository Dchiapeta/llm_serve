...
MAX_BODY_BYTES_BY_PATH: dict[str, int] = {
    ...
    # IMAGE_MAX_REFERENCE_IMAGES × IMAGE_MAX_FILE_SIZE_MB (4 × 10 MiB desde
    # 13/09/2026) + folga pras boundaries e campos de texto do multipart.
    # Espelha max_edit_bytes() de docker/gateway/image_proxy.py: um teto MENOR
    # aqui recusaria no pod o que o gateway deixou passar.
    #
    # Os 5 MiB viraram 10 porque a resolução da referência é o que decide a
    # fidelidade da peça na edição, não só o tamanho do upload. Os TRÊS tetos
    # (gateway, agent e IMAGE_MAX_FILE_SIZE_MB do pod) têm de andar juntos: o
    # menor deles é o que vale, e é o único que aparece pro cliente.
    "images/edits": 4 * 10 * _MIB + _MIB,
}
